...
export const keywords: Record<string, string[]> = {
  block: ['basefee', 'chainid', 'coinbase', 'difficulty', 'gaslimit', 'number', 'prevrandao', 'timestamp'],
  blockhash: [],
  gasleft: [],
  msg: ['data', 'sender', 'sig', 'value'],
  tx: ['gasprice', 'origin'],
  abi: ['decode', 'encode', 'encodePacked', 'encodeWithSelector', 'encodeWithSignature', 'encodeCall'],
};
